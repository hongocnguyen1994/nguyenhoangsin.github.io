...
// });
// $('.jsWriteNews').click(function() {
//     $('.modal-write-news.add').modal('show');
//     resizeHeightBox();
// });
// $('.profile-blog .profile-blog__body .profile-control__btn').click(function() {
//     $('.modal-write-news.edit').modal('show');
//     resizeHeightBox();
// });
...
/* Upload image */
// $('.modal-write-news__file').change(function(event) {
//     var input = event.target;
//     var reader = new FileReader();
//     var index = $('.modal-write-news__file').index(this);
//     reader.onload = function() {
//         var dataURL = reader.result;
//         var output = document.getElementsByClassName('modal-write-news__img');
...
function resizeHeightBox() {
    ...
    var modalWriteBlogImgAdd = $('.modal-write-news.add .modal-write-news__img');
    var modalWriteBlogImgEdit = $('.modal-write-news.edit .modal-write-news__img');
...
setRateElement($('.jsSetRate-3-2'), 3, 2);
setRateElement($('.jsSetRate-5-3'));
setRateElement($('.setRate-4-3'),4,3);
...
$(window).resize(function() {
    ...
    timer = setTimeout(function() {
        resizeHeightBox();
        setRateImages($('.jsSetRateImages-1-1'), 1, 1);
        setRateImages($('.jsSetRateImages-5-3'));
        setRateImages($('.jsSetRateImages-4-3'), 4, 3);
        setRateElement($('.jsSetRate-3-2'), 3, 2);
        setRateElement($('.jsSetRate-5-3'));
        setRateElement($('.setRate-4-3'),4,3);
    }, 300);
